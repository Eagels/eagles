...
void main() {
	...
	gl_FragColor = pack2HalfToRGBA( vec2( mean, std_dev ) );
		...
		}`};const cM=""+new URL("waternormals-add9912b.jpg",import.meta.url).href,uM=Br({__name:"Canvas",setup(n){let e,t,i,r,s,a,o,l;const c={elevation:0,azimuth:180};Ra(()=>{u(),m()});function u(){e=document.getElementById("CanvasGround")||document.body,r=new Bf,r.setPixelRatio(window.devicePixelRatio),r.setSize(window.innerWidth,window.innerHeight),r.toneMapping=cf,r.toneMappingExposure=.5,e.appendChild(r.domElement),i=new Bc,t=new Nt(55,window.innerWidth/window.innerHeight,1,2e4),t.position.set(30,30,100),o=new F;const w=new qs(1e4,1e4);a=new lM(w,{textureWidth:512,textureHeight:512,waterNormals:new sM().load(cM,function(D){D.wrapS=D.wrapT=As}),sunDirection:new F,sunColor:16777215,waterColor:3049652,distortionScale:3.7,fog:i.fog!==void 0}),a.rotation.x=-Math.PI/2,i.add(a),l=new js,l.scale.setScalar(1e4),i.add(l);const A=l.material.uniforms;A.turbidity.value=10,A.rayleigh.value=2,A.mieCoefficient.value=.005,A.mieDirectionalG.value=.8,_(l),s=new aM(t,r.domElement),s.maxPolarAngle=Math.PI*.495,s.target.set(20,40,0),s.minDistance=40,s.maxDistance=200,s.enabled=!1,s.update(),window.addEventListener("resize",x)}let f=new Bc,h,p;function _(w){f.remove(w),i.remove(w);const A=aa.degToRad(90-c.elevation),D=aa.degToRad(c.azimuth);o.setFromSphericalCoords(1,A,D),w.material.uniforms.sunPosition.value.copy(o),a.material.uniforms.sunDirection.value.copy(o).normalize(),h!==void 0&&(p==null||p.dispose()),p=new la(r),h!==void 0&&h.dispose(),f.add(w),h=p.fromScene(f),i.add(w),i.environment=h.texture}function x(){t.aspect=window.innerWidth/window.innerHeight,t.updateProjectionMatrix(),r.setSize(window.innerWidth,window.innerHeight)}function m(){requestAnimationFrame(m),M()}let d=new Date().getMinutes(),y=!0;function M(){const w=new Date().getSeconds();if(d!==w){d=w,c.elevation>=90&&(y=!1,c.elevation=.55),c.elevation<=-90&&(y=!0,c.elevation=-.55);let A=y?.05:-.05;c.elevation+=A,_(l)}a.material.uniforms.time.value+=.8/60,r.render(i,t)}return(w,A)=>(La(),Qu("div",{id:"CanvasGround",class:Or(Wn(Op).Canvas_index)},null,2))}}),fM={class:"content"},hM=Br({__name:"Base",setup(n){return(e,t)=>{const i=Ad("RouterView");return La(),Qu("div",{class:Or(Wn(Np).index_base)},[Ct(uM),Da("div",fM,[Ct(i)])],2)}}}),dM=Br({__name:"App",setup(n){return(e,t)=>(La(),Yd(hM))}}),pM="modulepreload",mM=function(n,e){return new URL(n,e).href},Wc={},Xc=function(e,t,i){if(!t||t.length===0)return e();const r=document.getElementsByTagName("link");return Promise.all(t.map(s=>{if(s=mM(s,i),s in Wc)return;Wc[s]=!0;const a=s.endsWith(".css"),o=a?'[rel="stylesheet"]':"";if(!!i)for(let u=r.length-1;u>=0;u--){const f=r[u];if(f.href===s&&(!a||f.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${s}"]${o}`))return;const c=document.createElement("link");if(c.rel=a?"stylesheet":pM,a||(c.as="script",c.crossOrigin=""),c.href=s,document.head.appendChild(c),a)return new Promise((u,f)=>{c.addEventListener("load",u),c.addEventListener("error",()=>f(new Error(`Unable to preload CSS for ${s}`)))})})).then(()=>e()).catch(s=>{const a=new Event("vite:preloadError",{cancelable:!0});if(a.payload=s,window.dispatchEvent(a),!a.defaultPrevented)throw s})};/*!
  * vue-router v4.2.4
  * (c) 2023 Eduardo San Martin Morote
  * @license MIT
  */const Vi=typeof window<"u";function gM(n){return n.__esModule||n[Symbol.toStringTag]==="Module"}const Ze=Object.assign;function Bo(n,e){const t={};for(const i in e){const r=e[i];t[i]=tn(r)?r.map(n):n(r)}return t}const Tr=()=>{},tn=Array.isArray,_M=/\/$/,vM=n=>n.replace(_M,"");function zo(n,e,t="/"){let i,r={},s="",a="";const o=e.indexOf("#");let l=e.indexOf("?");return o<l&&o>=0&&(l=-1),l>-1&&(i=e.slice(0,l),s=e.slice(l+1,o>-1?o:e.length),r=n(s)),o>-1&&(i=i||e.slice(0,o),a=e.slice(o,e.length)),i=SM(i??e,t),{fullPath:i+(s&&"?")+s+a,path:i,query:r,hash:a}}function xM(n,e){const t=e.query?n(e.query):"";return e.path+(t&&"?")+t+(e.hash||"")}function qc(n,e){return!e||!n.toLowerCase().startsWith(e.toLowerCase())?n:n.slice(e.length)||"/"}function MM(n,e,t){const i=e.matched.length-1,r=t.matched.length-1;return i>-1&&i===r&&nr(e.matched[i],t.matched[r])&&zf(e.params,t.params)&&n(e.query)===n(t.query)&&e.hash===t.hash}function nr(n,e){return(n.aliasOf||n)===(e.aliasOf||e)}function zf(n,e){if(Object.keys(n).length!==Object.keys(e).length)return!1;for(const t in n)if(!EM(n[t],e[t]))return!1;return!0}function EM(n,e){return tn(n)?Yc(n,e):tn(e)?Yc(e,n):n===e}function Yc(n,e){return tn(e)?n.length===e.length&&n.every((t,i)=>t===e[i]):n.length===1&&n[0]===e}function SM(n,e){if(n.startsWith("/"))return n;if(!n)return e;const t=e.split("/"),i=n.split("/"),r=i[i.length-1];(r===".."||r===".")&&i.push("");let s=t.length-1,a,o;for(a=0;a<i.length;a++)if(o=i[a],o!==".")if(o==="..")s>1&&s--;else break;return t.slice(0,s).join("/")+"/"+i.slice(a-(a===i.length?1:0)).join("/")}var Fr;(function(n){n.pop="pop",n.push="push"})(Fr||(Fr={}));var br;(function(n){n.back="back",n.forward="forward",n.unknown=""})(br||(br={}));function yM(n){if(!n)if(Vi){const e=document.querySelector("base");n=e&&e.getAttribute("href")||"/",n=n.replace(/^\w+:\/\/[^\/]+/,"")}else n="/";return n[0]!=="/"&&n[0]!=="#"&&(n="/"+n),vM(n)}const TM=/^[^#]+#/;function bM(n,e){return n.replace(TM,"#")+e}function AM(n,e){const t=document.documentElement.getBoundingClientRect(),i=n.getBoundingClientRect();return{behavior:e.behavior,left:i.left-t.left-(e.left||0),top:i.top-t.top-(e.top||0)}}const Ks=()=>({left:window.pageXOffset,top:window.pageYOffset});function wM(n){let e;if("el"in n){const t=n.el,i=typeof t=="string"&&t.startsWith("#"),r=typeof t=="string"?i?document.getElementById(t.slice(1)):document.querySelector(t):t;if(!r)return;e=AM(r,n)}else e=n;"scrollBehavior"in document.documentElement.style?window.scrollTo(e):window.scrollTo(e.left!=null?e.left:window.pageXOffset,e.top!=null?e.top:window.pageYOffset)}function jc(n,e){return(history.state?history.state.position-e:-1)+n}const ua=new Map;function RM(n,e){ua.set(n,e)}function CM(n){const e=ua.get(n);return ua.delete(n),e}let PM=()=>location.protocol+"//"+location.host;function Hf(n,e){const{pathname:t,search:i,hash:r}=e,s=n.indexOf("#");if(s>-1){let o=r.includes(n.slice(s))?n.slice(s).length:1,l=r.slice(o);return l[0]!=="/"&&(l="/"+l),qc(l,"")}return qc(t,n)+i+r}function LM(n,e,t,i){let r=[],s=[],a=null;const o=({state:h})=>{const p=Hf(n,location),_=t.value,x=e.value;let m=0;if(h){if(t.value=p,e.value=h,a&&a===_){a=null;return}m=x?h.position-x.position:0}else i(p);r.forEach(d=>{d(t.value,_,{delta:m,type:Fr.pop,direction:m?m>0?br.forward:br.back:br.unknown})})};function l(){a=t.value}function c(h){r.push(h);const p=()=>{const _=r.indexOf(h);_>-1&&r.splice(_,1)};return s.push(p),p}function u(){const{history:h}=window;h.state&&h.replaceState(Ze({},h.state,{scroll:Ks()}),"")}function f(){for(const h of s)h();s=[],window.removeEventListener("popstate",o),window.removeEventListener("beforeunload",u)}return window.addEventListener("popstate",o),window.addEventListener("beforeunload",u,{passive:!0}),{pauseListeners:l,listen:c,destroy:f}}function Kc(n,e,t,i=!1,r=!1){return{back:n,current:e,forward:t,replaced:i,position:window.history.length,scroll:r?Ks():null}}function DM(n){const{history:e,location:t}=window,i={value:Hf(n,t)},r={value:e.state};r.value||s(i.value,{back:null,current:i.value,forward:null,position:e.length-1,replaced:!0,scroll:null},!0);function s(l,c,u){const f=n.indexOf("#"),h=f>-1?(t.host&&document.querySelector("base")?n:n.slice(f))+l:PM()+n+l;try{e[u?"replaceState":"pushState"](c,"",h),r.value=c}catch(p){console.error(p),t[u?"replace":"assign"](h)}}function a(l,c){const u=Ze({},e.state,Kc(r.value.back,l,r.value.forward,!0),c,{position:r.value.position});s(l,u,!0),i.value=l}function o(l,c){const u=Ze({},r.value,e.state,{forward:l,scroll:Ks()});s(u.current,u,!0);const f=Ze({},Kc(i.value,l,null),{position:u.position+1},c);s(l,f,!1),i.value=l}return{location:i,state:r,push:o,replace:a}}function UM(n){n=yM(n);const e=DM(n),t=LM(n,e.state,e.location,e.replace);function i(s,a=!0){a||t.pauseListeners(),history.go(s)}const r=Ze({location:"",base:n,go:i,createHref:bM.bind(null,n)},e,t);return Object.defineProperty(r,"location",{enumerable:!0,get:()=>e.location.value}),Object.defineProperty(r,"state",{enumerable:!0,get:()=>e.state.value}),r}function IM(n){return typeof n=="string"||n&&typeof n=="object"}function Gf(n){return typeof n=="string"||typeof n=="symbol"}const Bn={path:"/",name:void 0,params:{},query:{},hash:"",fullPath:"/",matched:[],meta:{},redirectedFrom:void 0},Vf=Symbol("");var $c;(function(n){n[n.aborted=4]="aborted",n[n.cancelled=8]="cancelled",n[n.duplicated=16]="duplicated"})($c||($c={}));function ir(n,e){return Ze(new Error,{type:n,[Vf]:!0},e)}function Mn(n,e){return n instanceof Error&&Vf in n&&(e==null||!!(n.type&e))}const Zc="[^/]+?",NM={sensitive:!1,strict:!1,start:!0,end:!0},FM=/[.+*?^${}()[\]/\\]/g;function OM(n,e){const t=Ze({},NM,e),i=[];let r=t.start?"^":"";const s=[];for(const c of n){const u=c.length?[]:[90];t.strict&&!c.length&&(r+="/");for(let f=0;f<c.length;f++){const h=c[f];let p=40+(t.sensitive?.25:0);if(h.type===0)f||(r+="/"),r+=h.value.replace(FM,"\\$&"),p+=40;else if(h.type===1){const{value:_,repeatable:x,optional:m,regexp:d}=h;s.push({name:_,repeatable:x,optional:m});const y=d||Zc;if(y!==Zc){p+=10;try{new RegExp(`(${y})`)}catch(w){throw new Error(`Invalid custom RegExp for param "${_}" (${y}): `+w.message)}}let M=x?`((?:${y})(?:/(?:${y}))*)`:`(${y})`;f||(M=m&&c.length<2?`(?:/${M})`:"/"+M),m&&(M+="?"),r+=M,p+=20,m&&(p+=-8),x&&(p+=-20),y===".*"&&(p+=-50)}u.push(p)}i.push(u)}if(t.strict&&t.end){const c=i.length-1;i[c][i[c].length-1]+=.7000000000000001}t.strict||(r+="/?"),t.end?r+="$":t.strict&&(r+="(?:/|$)");const a=new RegExp(r,t.sensitive?"":"i");function o(c){const u=c.match(a),f={};if(!u)return null;for(let h=1;h<u.length;h++){const p=u[h]||"",_=s[h-1];f[_.name]=p&&_.repeatable?p.split("/"):p}return f}function l(c){let u="",f=!1;for(const h of n){(!f||!u.endsWith("/"))&&(u+="/"),f=!1;for(const p of h)if(p.type===0)u+=p.value;else if(p.type===1){const{value:_,repeatable:x,optional:m}=p,d=_ in c?c[_]:"";if(tn(d)&&!x)throw new Error(`Provided param "${_}" is an array but it is not repeatable (* or + modifiers)`);const y=tn(d)?d.join("/"):d;if(!y)if(m)h.length<2&&(u.endsWith("/")?u=u.slice(0,-1):f=!0);else throw new Error(`Missing required param "${_}"`);u+=y}}return u||"/"}return{re:a,score:i,keys:s,parse:o,stringify:l}}function BM(n,e){let t=0;for(;t<n.length&&t<e.length;){const i=e[t]-n[t];if(i)return i;t++}return n.length<e.length?n.length===1&&n[0]===40+40?-1:1:n.length>e.length?e.length===1&&e[0]===40+40?1:-1:0}function zM(n,e){let t=0;const i=n.score,r=e.score;for(;t<i.length&&t<r.length;){const s=BM(i[t],r[t]);if(s)return s;t++}if(Math.abs(r.length-i.length)===1){if(Jc(i))return 1;if(Jc(r))return-1}return r.length-i.length}function Jc(n){const e=n[n.length-1];return n.length>0&&e[e.length-1]<0}const HM={type:0,value:""},GM=/[a-zA-Z0-9_]/;function VM(n){if(!n)return[[]];if(n==="/")return[[HM]];if(!n.startsWith("/"))throw new Error(`Invalid path "${n}"`);function e(p){throw new Error(`ERR (${t})/"${c}": ${p}`)}let t=0,i=t;const r=[];let s;function a(){s&&r.push(s),s=[]}let o=0,l,c="",u="";function f(){c&&(t===0?s.push({type:0,value:c}):t===1||t===2||t===3?(s.length>1&&(l==="*"||l==="+")&&e(`A repeatable param (${c}) must be alone in its segment. eg: '/:ids+.`),s.push({type:1,value:c,regexp:u,repeatable:l==="*"||l==="+",optional:l==="*"||l==="?"})):e("Invalid state to consume buffer"),c="")}function h(){c+=l}for(;o<n.length;){if(l=n[o++],l==="\\"&&t!==2){i=t,t=4;continue}switch(t){case 0:l==="/"?(c&&f(),a()):l===":"?(f(),t=1):h();break;case 4:h(),t=i;break;case 1:l==="("?t=2:GM.test(l)?h():(f(),t=0,l!=="*"&&l!=="?"&&l!=="+"&&o--);break;case 2:l===")"?u[u.length-1]=="\\"?u=u.slice(0,-1)+l:t=3:u+=l;break;case 3:f(),t=0,l!=="*"&&l!=="?"&&l!=="+"&&o--,u="";break;default:e("Unknown state");break}}return t===2&&e(`Unfinished custom RegExp for param "${c}"`),f(),a(),r}function kM(n,e,t){const i=OM(VM(n.path),t),r=Ze(i,{record:n,parent:e,children:[],alias:[]});return e&&!r.record.aliasOf==!e.record.aliasOf&&e.children.push(r),r}function WM(n,e){const t=[],i=new Map;e=tu({strict:!1,end:!0,sensitive:!1},e);function r(u){return i.get(u)}function s(u,f,h){const p=!h,_=XM(u);_.aliasOf=h&&h.record;const x=tu(e,u),m=[_];if("alias"in u){const M=typeof u.alias=="string"?[u.alias]:u.alias;for(const w of M)m.push(Ze({},_,{components:h?h.record.components:_.components,path:w,aliasOf:h?h.record:_}))}let d,y;for(const M of m){const{path:w}=M;if(f&&w[0]!=="/"){const A=f.record.path,D=A[A.length-1]==="/"?"":"/";M.path=f.record.path+(w&&D+w)}if(d=kM(M,f,x),h?h.alias.push(d):(y=y||d,y!==d&&y.alias.push(d),p&&u.name&&!eu(d)&&a(u.name)),_.children){const A=_.children;for(let D=0;D<A.length;D++)s(A[D],d,h&&h.children[D])}h=h||d,(d.record.components&&Object.keys(d.record.components).length||d.record.name||d.record.redirect)&&l(d)}return y?()=>{a(y)}:Tr}function a(u){if(Gf(u)){const f=i.get(u);f&&(i.delete(u),t.splice(t.indexOf(f),1),f.children.forEach(a),f.alias.forEach(a))}else{const f=t.indexOf(u);f>-1&&(t.splice(f,1),u.record.name&&i.delete(u.record.name),u.children.forEach(a),u.alias.forEach(a))}}function o(){return t}function l(u){let f=0;for(;f<t.length&&zM(u,t[f])>=0&&(u.record.path!==t[f].record.path||!kf(u,t[f]));)f++;t.splice(f,0,u),u.record.name&&!eu(u)&&i.set(u.record.name,u)}function c(u,f){let h,p={},_,x;if("name"in u&&u.name){if(h=i.get(u.name),!h)throw ir(1,{location:u});x=h.record.name,p=Ze(Qc(f.params,h.keys.filter(y=>!y.optional).map(y=>y.name)),u.params&&Qc(u.params,h.keys.map(y=>y.name))),_=h.stringify(p)}else if("path"in u)_=u.path,h=t.find(y=>y.re.test(_)),h&&(p=h.parse(_),x=h.record.name);else{if(h=f.name?i.get(f.name):t.find(y=>y.re.test(f.path)),!h)throw ir(1,{location:u,currentLocation:f});x=h.record.name,p=Ze({},f.params,u.params),_=h.stringify(p)}const m=[];let d=h;for(;d;)m.unshift(d.record),d=d.parent;return{name:x,path:_,params:p,matched:m,meta:YM(m)}}return n.forEach(u=>s(u)),{addRoute:s,resolve:c,removeRoute:a,getRoutes:o,getRecordMatcher:r}}function Qc(n,e){const t={};for(const i of e)i in n&&(t[i]=n[i]);return t}function XM(n){return{path:n.path,redirect:n.redirect,name:n.name,meta:n.meta||{},aliasOf:void 0,beforeEnter:n.beforeEnter,props:qM(n),children:n.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in n?n.components||null:n.component&&{default:n.component}}}function qM(n){const e={},t=n.props||!1;if("component"in n)e.default=t;else for(const i in n.components)e[i]=typeof t=="object"?t[i]:t;return e}function eu(n){for(;n;){if(n.record.aliasOf)return!0;n=n.parent}return!1}function YM(n){return n.reduce((e,t)=>Ze(e,t.meta),{})}function tu(n,e){const t={};for(const i in n)t[i]=i in e?e[i]:n[i];return t}function kf(n,e){return e.children.some(t=>t===n||kf(n,t))}const Wf=/#/g,jM=/&/g,KM=/\//g,$M=/=/g,ZM=/\?/g,Xf=/\+/g,JM=/%5B/g,QM=/%5D/g,qf=/%5E/g,eE=/%60/g,Yf=/%7B/g,tE=/%7C/g,jf=/%7D/g,nE=/%20/g;function Ga(n){return encodeURI(""+n).replace(tE,"|").replace(JM,"[").replace(QM,"]")}function iE(n){return Ga(n).replace(Yf,"{").replace(jf,"}").replace(qf,"^")}function fa(n){return Ga(n).replace(Xf,"%2B").replace(nE,"+").replace(Wf,"%23").replace(jM,"%26").replace(eE,"`").replace(Yf,"{").replace(jf,"}").replace(qf,"^")}function rE(n){return fa(n).replace($M,"%3D")}function sE(n){return Ga(n).replace(Wf,"%23").replace(ZM,"%3F")}function oE(n){return n==null?"":sE(n).replace(KM,"%2F")}function Ps(n){try{return decodeURIComponent(""+n)}catch{}return""+n}function aE(n){const e={};if(n===""||n==="?")return e;const i=(n[0]==="?"?n.slice(1):n).split("&");for(let r=0;r<i.length;++r){const s=i[r].replace(Xf," "),a=s.indexOf("="),o=Ps(a<0?s:s.slice(0,a)),l=a<0?null:Ps(s.slice(a+1));if(o in e){let c=e[o];tn(c)||(c=e[o]=[c]),c.push(l)}else e[o]=l}return e}function nu(n){let e="";for(let t in n){const i=n[t];if(t=rE(t),i==null){i!==void 0&&(e+=(e.length?"&":"")+t);continue}(tn(i)?i.map(s=>s&&fa(s)):[i&&fa(i)]).forEach(s=>{s!==void 0&&(e+=(e.length?"&":"")+t,s!=null&&(e+="="+s))})}return e}function lE(n){const e={};for(const t in n){const i=n[t];i!==void 0&&(e[t]=tn(i)?i.map(r=>r==null?null:""+r):i==null?i:""+i)}return e}const cE=Symbol(""),iu=Symbol(""),Va=Symbol(""),Kf=Symbol(""),ha=Symbol("");function mr(){let n=[];function e(i){return n.push(i),()=>{const r=n.indexOf(i);r>-1&&n.splice(r,1)}}function t(){n=[]}return{add:e,list:()=>n.slice(),reset:t}}function Hn(n,e,t,i,r){const s=i&&(i.enterCallbacks[r]=i.enterCallbacks[r]||[]);return()=>new Promise((a,o)=>{const l=f=>{f===!1?o(ir(4,{from:t,to:e})):f instanceof Error?o(f):IM(f)?o(ir(2,{from:e,to:f})):(s&&i.enterCallbacks[r]===s&&typeof f=="function"&&s.push(f),a())},c=n.call(i&&i.instances[r],e,t,l);let u=Promise.resolve(c);n.length<3&&(u=u.then(l)),u.catch(f=>o(f))})}function Ho(n,e,t,i){const r=[];for(const s of n)for(const a in s.components){let o=s.components[a];if(!(e!=="beforeRouteEnter"&&!s.instances[a]))if(uE(o)){const c=(o.__vccOpts||o)[e];c&&r.push(Hn(c,t,i,s,a))}else{let l=o();r.push(()=>l.then(c=>{if(!c)return Promise.reject(new Error(`Couldn't resolve component "${a}" at "${s.path}"`));const u=gM(c)?c.default:c;s.components[a]=u;const h=(u.__vccOpts||u)[e];return h&&Hn(h,t,i,s,a)()}))}}return r}function uE(n){return typeof n=="object"||"displayName"in n||"props"in n||"__vccOpts"in n}function ru(n){const e=An(Va),t=An(Kf),i=$t(()=>e.resolve(Wn(n.to))),r=$t(()=>{const{matched:l}=i.value,{length:c}=l,u=l[c-1],f=t.matched;if(!u||!f.length)return-1;const h=f.findIndex(nr.bind(null,u));if(h>-1)return h;const p=su(l[c-2]);return c>1&&su(u)===p&&f[f.length-1].path!==p?f.findIndex(nr.bind(null,l[c-2])):h}),s=$t(()=>r.value>-1&&pE(t.params,i.value.params)),a=$t(()=>r.value>-1&&r.value===t.matched.length-1&&zf(t.params,i.value.params));function o(l={}){return dE(l)?e[Wn(n.replace)?"replace":"push"](Wn(n.to)).catch(Tr):Promise.resolve()}return{route:i,href:$t(()=>i.value.href),isActive:s,isExactActive:a,navigate:o}}const fE=Br({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"}},useLink:ru,setup(n,{slots:e}){const t=Fs(ru(n)),{options:i}=An(Va),r=$t(()=>({[ou(n.activeClass,i.linkActiveClass,"router-link-active")]:t.isActive,[ou(n.exactActiveClass,i.linkExactActiveClass,"router-link-exact-active")]:t.isExactActive}));return()=>{const s=e.default&&e.default(t);return n.custom?s:rf("a",{"aria-current":t.isExactActive?n.ariaCurrentValue:null,href:t.href,onClick:t.navigate,class:r.value},s)}}}),hE=fE;function dE(n){if(!(n.metaKey||n.altKey||n.ctrlKey||n.shiftKey)&&!n.defaultPrevented&&!(n.button!==void 0&&n.button!==0)){if(n.currentTarget&&n.currentTarget.getAttribute){const e=n.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(e))return}return n.preventDefault&&n.preventDefault(),!0}}function pE(n,e){for(const t in e){const i=e[t],r=n[t];if(typeof i=="string"){if(i!==r)return!1}else if(!tn(r)||r.length!==i.length||i.some((s,a)=>s!==r[a]))return!1}return!0}function su(n){return n?n.aliasOf?n.aliasOf.path:n.path:""}const ou=(n,e,t)=>n??e??t,mE=Br({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(n,{attrs:e,slots:t}){const i=An(ha),r=$t(()=>n.route||i.value),s=An(iu,0),a=$t(()=>{let c=Wn(s);const{matched:u}=r.value;let f;for(;(f=u[c])&&!f.components;)c++;return c}),o=$t(()=>r.value.matched[a.value]);_s(iu,$t(()=>a.value+1)),_s(cE,o),_s(ha,r);const l=Yh();return vs(()=>[l.value,o.value,n.name],([c,u,f],[h,p,_])=>{u&&(u.instances[f]=c,p&&p!==u&&c&&c===h&&(u.leaveGuards.size||(u.leaveGuards=p.leaveGuards),u.updateGuards.size||(u.updateGuards=p.updateGuards))),c&&u&&(!p||!nr(u,p)||!h)&&(u.enterCallbacks[f]||[]).forEach(x=>x(c))},{flush:"post"}),()=>{const c=r.value,u=n.name,f=o.value,h=f&&f.components[u];if(!h)return au(t.default,{Component:h,route:c});const p=f.props[u],_=p?p===!0?c.params:typeof p=="function"?p(c):p:null,m=rf(h,Ze({},_,e,{onVnodeUnmounted:d=>{d.component.isUnmounted&&(f.instances[u]=null)},ref:l}));return au(t.default,{Component:m,route:c})||m}}});function au(n,e){if(!n)return null;const t=n(e);return t.length===1?t[0]:t}const gE=mE;function _E(n){const e=WM(n.routes,n),t=n.parseQuery||aE,i=n.stringifyQuery||nu,r=n.history,s=mr(),a=mr(),o=mr(),l=jh(Bn);let c=Bn;Vi&&n.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const u=Bo.bind(null,H=>""+H),f=Bo.bind(null,oE),h=Bo.bind(null,Ps);function p(H,oe){let he,we;return Gf(H)?(he=e.getRecordMatcher(H),we=oe):we=H,e.addRoute(we,he)}function _(H){const oe=e.getRecordMatcher(H);oe&&e.removeRoute(oe)}function x(){return e.getRoutes().map(H=>H.record)}function m(H){return!!e.getRecordMatcher(H)}function d(H,oe){if(oe=Ze({},oe||l.value),typeof H=="string"){const L=zo(t,H,oe.path),N=e.resolve({path:L.path},oe),V=r.createHref(L.fullPath);return Ze(L,N,{params:h(N.params),hash:Ps(L.hash),redirectedFrom:void 0,href:V})}let he;if("path"in H)he=Ze({},H,{path:zo(t,H.path,oe.path).path});else{const L=Ze({},H.params);for(const N in L)L[N]==null&&delete L[N];he=Ze({},H,{params:f(L)}),oe.params=f(oe.params)}const we=e.resolve(he,oe),Ce=H.hash||"";we.params=u(h(we.params));const g=xM(i,Ze({},H,{hash:iE(Ce),path:we.path})),C=r.createHref(g);return Ze({fullPath:g,hash:Ce,query:i===nu?lE(H.query):H.query||{}},we,{redirectedFrom:void 0,href:C})}function y(H){return typeof H=="string"?zo(t,H,l.value.path):Ze({},H)}function M(H,oe){if(c!==H)return ir(8,{from:oe,to:H})}function w(H){return R(H)}function A(H){return w(Ze(y(H),{replace:!0}))}function D(H){const oe=H.matched[H.matched.length-1];if(oe&&oe.redirect){const{redirect:he}=oe;let we=typeof he=="function"?he(H):he;return typeof we=="string"&&(we=we.includes("?")||we.includes("#")?we=y(we):{path:we},we.params={}),Ze({query:H.query,hash:H.hash,params:"path"in we?{}:H.params},we)}}function R(H,oe){const he=c=d(H),we=l.value,Ce=H.state,g=H.force,C=H.replace===!0,L=D(he);if(L)return R(Ze(y(L),{state:typeof L=="object"?Ze({},Ce,L.state):Ce,force:g,replace:C}),oe||he);const N=he;N.redirectedFrom=oe;let V;return!g&&MM(i,we,he)&&(V=ir(16,{to:N,from:we}),z(we,we,!0,!1)),(V?Promise.resolve(V):b(N,we)).catch(ne=>Mn(ne)?Mn(ne,2)?ne:pe(ne):W(ne,N,we)).then(ne=>{if(ne){if(Mn(ne,2))return R(Ze({replace:C},y(ne.to),{state:typeof ne.to=="object"?Ze({},Ce,ne.to.state):Ce,force:g}),oe||N)}else ne=fe(N,we,!0,C,Ce);return J(N,we,ne),ne})}function O(H,oe){const he=M(H,oe);return he?Promise.reject(he):Promise.resolve()}function S(H){const oe=Me.values().next().value;return oe&&typeof oe.runWithContext=="function"?oe.runWithContext(H):H()}function b(H,oe){let he;const[we,Ce,g]=vE(H,oe);he=Ho(we.reverse(),"beforeRouteLeave",H,oe);for(const L of we)L.leaveGuards.forEach(N=>{he.push(Hn(N,H,oe))});const C=O.bind(null,H,oe);return he.push(C),Pe(he).then(()=>{he=[];for(const L of s.list())he.push(Hn(L,H,oe));return he.push(C),Pe(he)}).then(()=>{he=Ho(Ce,"beforeRouteUpdate",H,oe);for(const L of Ce)L.updateGuards.forEach(N=>{he.push(Hn(N,H,oe))});return he.push(C),Pe(he)}).then(()=>{he=[];for(const L of g)if(L.beforeEnter)if(tn(L.beforeEnter))for(const N of L.beforeEnter)he.push(Hn(N,H,oe));else he.push(Hn(L.beforeEnter,H,oe));return he.push(C),Pe(he)}).then(()=>(H.matched.forEach(L=>L.enterCallbacks={}),he=Ho(g,"beforeRouteEnter",H,oe),he.push(C),Pe(he))).then(()=>{he=[];for(const L of a.list())he.push(Hn(L,H,oe));return he.push(C),Pe(he)}).catch(L=>Mn(L,8)?L:Promise.reject(L))}function J(H,oe,he){o.list().forEach(we=>S(()=>we(H,oe,he)))}function fe(H,oe,he,we,Ce){const g=M(H,oe);if(g)return g;const C=oe===Bn,L=Vi?history.state:{};he&&(we||C?r.replace(H.fullPath,Ze({scroll:C&&L&&L.scroll},Ce)):r.push(H.fullPath,Ce)),l.value=H,z(H,oe,he,C),pe()}let G;function K(){G||(G=r.listen((H,oe,he)=>{if(!Ae.listening)return;const we=d(H),Ce=D(we);if(Ce){R(Ze(Ce,{replace:!0}),we).catch(Tr);return}c=we;const g=l.value;Vi&&RM(jc(g.fullPath,he.delta),Ks()),b(we,g).catch(C=>Mn(C,12)?C:Mn(C,2)?(R(C.to,we).then(L=>{Mn(L,20)&&!he.delta&&he.type===Fr.pop&&r.go(-1,!1)}).catch(Tr),Promise.reject()):(he.delta&&r.go(-he.delta,!1),W(C,we,g))).then(C=>{C=C||fe(we,g,!1),C&&(he.delta&&!Mn(C,8)?r.go(-he.delta,!1):he.type===Fr.pop&&Mn(C,20)&&r.go(-1,!1)),J(we,g,C)}).catch(Tr)}))}let X=mr(),ee=mr(),q;function W(H,oe,he){pe(H);const we=ee.list();return we.length?we.forEach(Ce=>Ce(H,oe,he)):console.error(H),Promise.reject(H)}function se(){return q&&l.value!==Bn?Promise.resolve():new Promise((H,oe)=>{X.add([H,oe])})}function pe(H){return q||(q=!H,K(),X.list().forEach(([oe,he])=>H?he(H):oe()),X.reset()),H}function z(H,oe,he,we){const{scrollBehavior:Ce}=n;if(!Vi||!Ce)return Promise.resolve();const g=!he&&CM(jc(H.fullPath,0))||(we||!he)&&history.state&&history.state.scroll||null;return Pu().then(()=>Ce(H,oe,g)).then(C=>C&&wM(C)).catch(C=>W(C,H,oe))}const $=H=>r.go(H);let xe;const Me=new Set,Ae={currentRoute:l,listening:!0,addRoute:p,removeRoute:_,hasRoute:m,getRoutes:x,resolve:d,options:n,push:w,replace:A,go:$,back:()=>$(-1),forward:()=>$(1),beforeEach:s.add,beforeResolve:a.add,afterEach:o.add,onError:ee.add,isReady:se,install(H){const oe=this;H.component("RouterLink",hE),H.component("RouterView",gE),H.config.globalProperties.$router=oe,Object.defineProperty(H.config.globalProperties,"$route",{enumerable:!0,get:()=>Wn(l)}),Vi&&!xe&&l.value===Bn&&(xe=!0,w(r.location).catch(Ce=>{}));const he={};for(const Ce in Bn)Object.defineProperty(he,Ce,{get:()=>l.value[Ce],enumerable:!0});H.provide(Va,oe),H.provide(Kf,Mu(he)),H.provide(ha,l);const we=H.unmount;Me.add(H),H.unmount=function(){Me.delete(H),Me.size<1&&(c=Bn,G&&G(),G=null,l.value=Bn,xe=!1,q=!1),we()}}};function Pe(H){return H.reduce((oe,he)=>oe.then(()=>S(he)),Promise.resolve())}return Ae}function vE(n,e){const t=[],i=[],r=[],s=Math.max(e.matched.length,n.matched.length);for(let a=0;a<s;a++){const o=e.matched[a];o&&(n.matched.find(c=>nr(c,o))?i.push(o):t.push(o));const l=n.matched[a];l&&(e.matched.find(c=>nr(c,l))||r.push(l))}return[t,i,r]}const xE=[{path:"/",name:"home",alias:["/home","/home2"],component:()=>Xc(()=>import("./home-124ef952.js"),["./home-124ef952.js","./home-a4bf69a7.css"],import.meta.url),children:[{path:"/welcome",name:"welcome",component:()=>Xc(()=>import("./welcome-551f7734.js"),[],import.meta.url)}]}],ME=_E({history:UM(),routes:xE});Lp(dM).use(ME).mount("#app");export{$d as a,Ct as b,Qu as c,Br as d,La as o,Ad as r};
